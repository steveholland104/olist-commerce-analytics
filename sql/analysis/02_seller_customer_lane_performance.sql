-- Seller-to-customer state lane analysis
-- Purpose: Determine whether customer delivery performance varies based on the seller-state and customer-state pairing.
...
SELECT
    lane_summary.seller_state,
    lane_summary.customer_state,
